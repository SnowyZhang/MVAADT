...
from .modelSingleCell import Encoder_overall
from .preprocess import adjacent_matrix_preprocessing_OnlyFeature

class Train_MVAADT_SC:
    def __init__(self, 
        data,
        datatype = 'SPOTS',
        ...
        data: dict
            adata_omics1: AnnData
                AnnData object of omics1
            adata_omics2: AnnData
                AnnData object of omics2
        datatype: str
            the type of data, including  '10x', 'Spatial-epigenome-transcriptome'
        device: torch.device
        ...
        ------
        output: dict
            emb_latent_omics1: numpy.ndarray
                the latent representation of omics1
            emb_latent_omics2: numpy.ndarray
                the latent representation of omics2
            GAN_Align: numpy.ndarray
                the aligned latent representation
        """
        self.data = data.copy()
        ...
        self.adj = adjacent_matrix_preprocessing_OnlyFeature(self.adata_omics1, self.adata_omics2)
    ...
    def train(self):
        ...
        for epoch in tqdm(range(self.epochs)):
            self.model.train()
            results = self.model(self.features_omics1, self.features_omics2, self.adj_feature_omics1, self.adj_feature_omics2)
        ...
        torch.save(self.model.translation_12.state_dict(), '/home/zxx/SMI/translationSet/Thymus_Spleen_PBMC_translation12.pth')
        torch.save(self.model.translation_21.state_dict(), '/home/zxx/SMI/translationSet/Thymus_Spleen_PBMC_translation21.pth')
        # # save encoderModel
